...
- Catalogue favourites persist in the same browser and site, with clear storage limits. The profile shows actual visit activity and favourite count; fixed personal details, example pets and membership prices are removed. See the [favourites/profile update](favourites-profile-2026-09-14.md).
